  ...
  return <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-dark-300 to-dark-200 p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-white/70">Start creating amazing AI art</p>
        </div>
        <Card variant="glass" className="p-6">
          <form>
            <Input label="Name" type="text" placeholder="Enter your name" icon={<UserIcon size={18} />} required />
            <Input label="Email" type="email" placeholder="Enter your email" icon={<MailIcon size={18} />} required />
            <Input label="Password" type="password" placeholder="Create a password" icon={<LockIcon size={18} />} required />
            <div className="flex items-center mb-6">
              <input id="terms" name="terms" type="checkbox" className="h-4 w-4 rounded border-white/20 bg-white/5 text-primary-500 focus:ring-primary-500" required />
